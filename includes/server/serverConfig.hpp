...
namespace WSERV
{
    ...
    public:
        ...
        int 		get_maxfilesize( void ) const;
        std::string get_error_page( void ) const;
        std::string get_cgi_file_types( void ) const;
        int 		get_time_out( void ) const;
        std::vector<WSERV::Location> 	get_Location_vec( void ) const;
